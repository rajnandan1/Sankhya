        ...
        constructor() {
            ...
            const update = (evt, hide) => {
                ...
                if (res >= 1000000000) {
                    ...
                    let com = resExtra.replace("rupees", "") + " crore " + resCrore;
                    com = com[0].toUpperCase() + com.substr(1);
                    document.querySelector("#BharatSankhy-popper-content").innerHTML = `<span class="textnumber arab">${com}</span>`;
                    this.updateRect(hide);
                } else {
                    res = N2WIndian.convert(res).toLowerCase();
                    res = res[0].toUpperCase() + res.substr(1);
                    document.querySelector("#BharatSankhy-popper-content").innerHTML = `<span class="textnumber ${N2WIndian.getClass(res)}">${res}</span>`;
                    this.updateRect(hide);
                }
            };
...
BharatSankhyaPopMain.classList.add("popper");
